...
//execution for user inputs
UserInputs(userChoice, input);

//different spotify function choices and invalid choice message default
function UserInputs (userChoice, input){
    switch (userChoice) {
    case 'concert-this':
...
//function gets Rotten Tomatoes Rating
